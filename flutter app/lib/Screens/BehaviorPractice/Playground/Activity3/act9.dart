...
import 'package:ukussa_app/Screens/BehaviorPractice/Playground/Activity3/act10.dart';
import 'package:lottie/lottie.dart';
import 'package:audioplayers/audioplayers.dart';

class PlaygroundGoodBadActivity9 extends StatefulWidget {
  const PlaygroundGoodBadActivity9({super.key});

  @override
  State<PlaygroundGoodBadActivity9> createState() =>
      _PlaygroundGoodBadActivity9State();
}

class _PlaygroundGoodBadActivity9State
    extends State<PlaygroundGoodBadActivity9> {
  Timer? _timer;
  int _spentTime = 0;
  ...
  final String _correctAnswer = '3act9-1.png';
  final String _incorrectAnswer = '3act9-2.png';
  ...
  void _navigateToNext() {
    if (mounted) {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(
          builder: (context) => const PlaygroundGoodBadActivity10(),
        ),
      );
    }
  }
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        const Expanded(
                          child: Text(
                            "තරගයකින් පරාද වුනොත් හැසිරෙන්නේ කොහොමද?",
