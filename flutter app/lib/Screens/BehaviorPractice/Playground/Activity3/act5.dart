...
import 'package:ukussa_app/Screens/BehaviorPractice/Playground/Activity3/parentRatingPage.dart';
import 'package:ukussa_app/Screens/BehaviorPractice/Playground/Activity3/act6.dart';
import 'package:lottie/lottie.dart';
import 'package:audioplayers/audioplayers.dart';

class PlaygroundGoodBadActivity5 extends StatefulWidget {
  const PlaygroundGoodBadActivity5({super.key});

  @override
  State<PlaygroundGoodBadActivity5> createState() =>
      _PlaygroundGoodBadActivity5State();
}

class _PlaygroundGoodBadActivity5State
    extends State<PlaygroundGoodBadActivity5> {
  Timer? _timer;
  int _spentTime = 0;
  ...
  void _navigateToNext() {
    ...
    if (_isAnswered) {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(
          builder: (context) => const PlaygroundGoodBadActivity6(),
        ),
      );
    }
  }
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        const Expanded(
                          child: Text(
                            "යාලුවෙක් ලිස්සන බෝට්ටුවේ නගින්න බැරුව ඉන්නකොට, ඔයා මොකද කරන්නේ?",
