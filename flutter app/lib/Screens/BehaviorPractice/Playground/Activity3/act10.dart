...
import 'package:ukussa_app/Screens/BehaviorPractice/Playground/Activity3/celebrationPage.dart';
import 'package:lottie/lottie.dart';
import 'package:audioplayers/audioplayers.dart';

class PlaygroundGoodBadActivity10 extends StatefulWidget {
  const PlaygroundGoodBadActivity10({super.key});

  @override
  State<PlaygroundGoodBadActivity10> createState() =>
      _PlaygroundGoodBadActivity10State();
}

class _PlaygroundGoodBadActivity10State
    extends State<PlaygroundGoodBadActivity10> {
  Timer? _timer;
  int _spentTime = 0;
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        const Expanded(
                          child: Text(
                            "ඔයගේ යලුවො සෙල්ලම් කරමින් ඉන්නවා, ඔයා මොකද කරන්නේ?",
        ...
        child: Stack(
          ...
          children: [
            ClipRRect(
              ...
              child: Image.asset(
                'assets/images/pg-quiz/$imageName',
                width: size,
                height: size,
                fit: BoxFit.cover,
