...
import 'package:ukussa_app/Screens/BehaviorPractice/Playground/Activity3/act3.dart';
import 'package:lottie/lottie.dart';
import 'package:audioplayers/audioplayers.dart';

class PlaygroundGoodBadActivity2 extends StatefulWidget {
  const PlaygroundGoodBadActivity2({super.key});

  @override
  State<PlaygroundGoodBadActivity2> createState() =>
      _PlaygroundGoodBadActivity2State();
}

class _PlaygroundGoodBadActivity2State
    extends State<PlaygroundGoodBadActivity2> {
  Timer? _timer;
  int _spentTime = 0;
  ...
  final String _correctAnswer = '3act2-1.png';
  final String _incorrectAnswer = '3act2-2.png';
  ...
  void _navigateToNext() {
    if (mounted) {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(
          builder: (context) => const PlaygroundGoodBadActivity3(),
        ),
      );
    }
  }
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        const Expanded(
                          child: Text(
                            "යාලුවෙක් සෙල්ලමට එකතු වෙන්න අහද්දී, මොකද කරන්නේ?",
