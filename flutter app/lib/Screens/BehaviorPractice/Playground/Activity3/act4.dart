...
import 'package:ukussa_app/Screens/BehaviorPractice/Playground/Activity3/act5.dart';
import 'package:lottie/lottie.dart';
import 'package:audioplayers/audioplayers.dart';

class PlaygroundGoodBadActivity4 extends StatefulWidget {
  const PlaygroundGoodBadActivity4({super.key});

  @override
  State<PlaygroundGoodBadActivity4> createState() =>
      _PlaygroundGoodBadActivity4State();
}

class _PlaygroundGoodBadActivity4State
    extends State<PlaygroundGoodBadActivity4> {
  Timer? _timer;
  int _spentTime = 0;
  ...
  void _navigateToNext() {
    if (mounted) {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(
          builder: (context) => const PlaygroundGoodBadActivity5(),
        ),
      );
    }
  }
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        const Expanded(
                          child: Text(
                            "යාලුවෙක් සෙල්ලම් කරනකොට වැටුනහම මොකක්ද කරන්නේ?",
