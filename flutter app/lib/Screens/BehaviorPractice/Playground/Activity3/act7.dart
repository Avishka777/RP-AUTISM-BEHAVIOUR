...
import 'package:ukussa_app/Screens/BehaviorPractice/Playground/Activity3/act8.dart';
import 'package:lottie/lottie.dart';
import 'package:audioplayers/audioplayers.dart';

class PlaygroundGoodBadActivity7 extends StatefulWidget {
  const PlaygroundGoodBadActivity7({super.key});

  @override
  State<PlaygroundGoodBadActivity7> createState() =>
      _PlaygroundGoodBadActivity7State();
}

class _PlaygroundGoodBadActivity7State
    extends State<PlaygroundGoodBadActivity7> {
  Timer? _timer;
  int _spentTime = 0;
  ...
  final String _correctAnswer = '3act7-1.png';
  final String _incorrectAnswer = '3act7-2.png';
  ...
  void _navigateToNext() {
    if (mounted) {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(
          builder: (context) => const PlaygroundGoodBadActivity8(),
        ),
      );
    }
  }
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        const Expanded(
                          child: Text(
                            "ඔන්චිල්ලාව හොද ලමයෙක් වගේ පදින්නේ කොහොමද?",
