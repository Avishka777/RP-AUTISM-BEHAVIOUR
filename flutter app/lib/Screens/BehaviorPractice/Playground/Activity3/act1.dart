...
import 'package:ukussa_app/Screens/BehaviorPractice/Playground/Activity3/act2.dart';
import 'package:lottie/lottie.dart';
import 'package:audioplayers/audioplayers.dart';

class PlaygroundGoodBadActivity1 extends StatefulWidget {
  const PlaygroundGoodBadActivity1({super.key});

  @override
  State<PlaygroundGoodBadActivity1> createState() =>
      _PlaygroundGoodBadActivity1State();
}

class _PlaygroundGoodBadActivity1State
    extends State<PlaygroundGoodBadActivity1> {
  Timer? _timer;
  int _spentTime = 0;
  ...
  void _navigateToNext() {
    if (mounted) {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(
          builder: (context) => const PlaygroundGoodBadActivity2(),
        ),
      );
    }
  }
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        const Expanded(
                          child: Text(
                            "සෙල්ලම් පිට්ටනියේදී නිවැරදි හැසිරීම තෝරමු?",
