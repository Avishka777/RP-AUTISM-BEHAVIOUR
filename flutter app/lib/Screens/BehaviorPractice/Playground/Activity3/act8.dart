...
import 'package:ukussa_app/Screens/BehaviorPractice/Playground/Activity3/act9.dart';
import 'package:lottie/lottie.dart';
import 'package:audioplayers/audioplayers.dart';

class PlaygroundGoodBadActivity8 extends StatefulWidget {
  const PlaygroundGoodBadActivity8({super.key});

  @override
  State<PlaygroundGoodBadActivity8> createState() =>
      _PlaygroundGoodBadActivity8State();
}

class _PlaygroundGoodBadActivity8State
    extends State<PlaygroundGoodBadActivity8> {
  Timer? _timer;
  int _spentTime = 0;
  ...
  void _navigateToNext() {
    if (mounted) {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(
          builder: (context) => const PlaygroundGoodBadActivity9(),
        ),
      );
    }
  }
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        const Expanded(
                          child: Text(
                            "ලිස්සන බෝට්ටුවේ නිවැරදිව සෙල්ලම් කරන්නේ කොහොමද?",
