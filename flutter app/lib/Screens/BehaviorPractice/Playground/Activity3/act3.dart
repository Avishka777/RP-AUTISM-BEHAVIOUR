...
import 'package:ukussa_app/Screens/BehaviorPractice/Playground/Activity3/act4.dart';
import 'package:lottie/lottie.dart';
import 'package:audioplayers/audioplayers.dart';

class PlaygroundGoodBadActivity3 extends StatefulWidget {
  const PlaygroundGoodBadActivity3({super.key});

  @override
  State<PlaygroundGoodBadActivity3> createState() =>
      _PlaygroundGoodBadActivity3State();
}

class _PlaygroundGoodBadActivity3State
    extends State<PlaygroundGoodBadActivity3> {
  Timer? _timer;
  int _spentTime = 0;
  ...
  final String _correctAnswer = '3act3-1.png';
  final String _incorrectAnswer = '3act3-2.png';
  ...
  void _navigateToNext() {
    if (mounted) {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(
          builder: (context) => const PlaygroundGoodBadActivity4(),
        ),
      );
    }
  }
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        const Expanded(
                          child: Text(
                            "යාලුවෝ එක්ක ඔන්චිල්ලාව පදිද්දී කොහොමද හැසිරෙන්නේ?",
