...
import 'package:ukussa_app/Screens/BehaviorPractice/Playground/Activity3/act7.dart';
import 'package:lottie/lottie.dart';
import 'package:audioplayers/audioplayers.dart';

class PlaygroundGoodBadActivity6 extends StatefulWidget {
  const PlaygroundGoodBadActivity6({super.key});

  @override
  State<PlaygroundGoodBadActivity6> createState() =>
      _PlaygroundGoodBadActivity6State();
}

class _PlaygroundGoodBadActivity6State
    extends State<PlaygroundGoodBadActivity6> {
  Timer? _timer;
  int _spentTime = 0;
  ...
  final String _correctAnswer = '3act6-1.png';
  final String _incorrectAnswer = '3act6-2.png';
  ...
  void _navigateToNext() {
    if (mounted) {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(
          builder: (context) => const PlaygroundGoodBadActivity7(),
        ),
      );
    }
  }
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        const Expanded(
                          child: Text(
                            "බෝල සෙල්ලම් කරනකොට බෝලේ ඈතට ගිහාම ඔයා මොකද කරන්නේ?",
