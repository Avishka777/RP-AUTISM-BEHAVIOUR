...
import 'package:ukussa_app/Screens/BehaviorPractice/Playground/Activity2/celebrationPage.dart';
...
class _ParentRatingPageState extends State<ParentRatingPage> {
  ...
  Future<void> _submitData() async {
    ...
    try {
      await ActivityPreferences.setClassroomEquipmentCompleted(true);

      // Use SessionProvider to record activity2 data
      final session = context.read<BehaviorPracticeProvider>();

      // Calculate percentage marks as integer
      final percentMarks = ((widget.correctlyPlaced / widget.totalCorrect) * 100).round();
