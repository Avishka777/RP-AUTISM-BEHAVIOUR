...
import 'package:ukussa_app/Screens/BehaviorPractice/Playground/Activity1/parentRatingPage.dart';
...
class _PlaceRecognitionActivityState
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text("ක්‍රීඩා පිටිය හඳුනාගැනීම"),
        ...
        child: Column(
          children: [
            ClipRRect(
              ...
              child: Image.asset(
                'assets/images/pg-quiz/$imageName', // Make sure you have these images in your assets folder
                width: size,
                height: size,
                fit: BoxFit.cover,
              ),
