...
import 'package:ukussa_app/Screens/BehaviorPractice/Restaurant/Activity2/parentRatingPage.dart';
...
class ObjDetectionActivity extends StatefulWidget {
  ...
  @override
  State<ObjDetectionActivity> createState() => _ObjDetectionActivityState();
}
...
class _ObjDetectionActivityState extends State<ObjDetectionActivity> {
  ...
  void initState() {
    ...
    _items = List.generate(5, (index) {
      final imageName = "rs-drag${index + 1}";
                    ...
                    Expanded(
                      child: Row(
                        children: [
                          const Expanded(
                            child: Text(
                              "කෑම මේසයේ තියෙන දේවල් රවුම තුලට දමමු:",
                              style: TextStyle(
                                  fontSize: 18,
