...
import 'package:ukussa_app/Screens/BehaviorPractice/Restaurant/Activity3/act7.dart';
import 'package:lottie/lottie.dart';
import 'package:audioplayers/audioplayers.dart';

class RestaurantGoodBadActivity6 extends StatefulWidget {
  const RestaurantGoodBadActivity6({super.key});

  @override
  State<RestaurantGoodBadActivity6> createState() =>
      _RestaurantGoodBadActivity6State();
}

class _RestaurantGoodBadActivity6State
    extends State<RestaurantGoodBadActivity6> {
  Timer? _timer;
  int _spentTime = 0;
  ...
  void _navigateToNext() {
    if (mounted) {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(
          builder: (context) => const RestaurantGoodBadActivity7(),
        ),
      );
    }
  }
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        const Expanded(
                          child: Text(
                            "යාලුවගේ කෑම මුලින් ලැබුනොත් ඔයා කොහොමද හැසිරෙන්නේ?",
