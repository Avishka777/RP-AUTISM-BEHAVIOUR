...
import 'package:ukussa_app/Screens/BehaviorPractice/Restaurant/Activity3/act4.dart';
import 'package:lottie/lottie.dart';
import 'package:audioplayers/audioplayers.dart';

class RestaurantGoodBadActivity3 extends StatefulWidget {
  const RestaurantGoodBadActivity3({super.key});

  @override
  State<RestaurantGoodBadActivity3> createState() =>
      _RestaurantGoodBadActivity3State();
}

class _RestaurantGoodBadActivity3State
    extends State<RestaurantGoodBadActivity3> {
  Timer? _timer;
  int _spentTime = 0;
  ...
  void _navigateToNext() {
    if (mounted) {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(
          builder: (context) => const RestaurantGoodBadActivity4(),
        ),
      );
    }
  }
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        const Expanded(
                          child: Text(
                            "හැන්ද නිවැරිදිව භාවිතා කරන්නේ කොහොමද?",
