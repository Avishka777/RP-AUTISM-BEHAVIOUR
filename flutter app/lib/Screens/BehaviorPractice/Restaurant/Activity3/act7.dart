...
import 'package:ukussa_app/Screens/BehaviorPractice/Restaurant/Activity3/act8.dart';
import 'package:lottie/lottie.dart';
import 'package:audioplayers/audioplayers.dart';

class RestaurantGoodBadActivity7 extends StatefulWidget {
  const RestaurantGoodBadActivity7({super.key});

  @override
  State<RestaurantGoodBadActivity7> createState() =>
      _RestaurantGoodBadActivity7State();
}

class _RestaurantGoodBadActivity7State
    extends State<RestaurantGoodBadActivity7> {
  Timer? _timer;
  int _spentTime = 0;
  ...
  void _navigateToNext() {
    if (mounted) {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(
          builder: (context) => const RestaurantGoodBadActivity8(),
        ),
      );
    }
  }
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        const Expanded(
                          child: Text(
                            "යලුවෙක්ට කෑම කද්දි හිරවෙනවා, එවිට ඔයා මොකද කරන්නේ?",
