...
import 'package:ukussa_app/Screens/BehaviorPractice/Restaurant/Activity3/act9.dart';
import 'package:lottie/lottie.dart';
import 'package:audioplayers/audioplayers.dart';

class RestaurantGoodBadActivity8 extends StatefulWidget {
  const RestaurantGoodBadActivity8({super.key});

  @override
  State<RestaurantGoodBadActivity8> createState() =>
      _RestaurantGoodBadActivity8State();
}

class _RestaurantGoodBadActivity8State
    extends State<RestaurantGoodBadActivity8> {
  Timer? _timer;
  int _spentTime = 0;
  ...
  void _navigateToNext() {
    if (mounted) {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(
          builder: (context) => const RestaurantGoodBadActivity9(),
        ),
      );
    }
  }
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        const Expanded(
                          child: Text(
                            "මේසේ තියන පිහිය,ගෑරුප්පු නිවැරිදිව භාවිතා කරන්නේ කොහොමද?",
