...
import 'package:ukussa_app/Screens/BehaviorPractice/Restaurant/Activity3/act2.dart';
import 'package:lottie/lottie.dart';
import 'package:audioplayers/audioplayers.dart';

class RestaurantGoodBadActivity1 extends StatefulWidget {
  const RestaurantGoodBadActivity1({super.key});

  @override
  State<RestaurantGoodBadActivity1> createState() =>
      _RestaurantGoodBadActivity1State();
}

class _RestaurantGoodBadActivity1State
    extends State<RestaurantGoodBadActivity1> {
  Timer? _timer;
  int _spentTime = 0;
  ...
  void _navigateToNext() {
    if (mounted) {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(
          builder: (context) => const RestaurantGoodBadActivity2(),
        ),
      );
    }
  }
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        const Expanded(
                          child: Text(
                            "අවන්හලේදී කෑම ඕඩර් කරන්නේ කොහොමද?",
