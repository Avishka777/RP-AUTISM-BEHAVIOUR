...
import 'package:ukussa_app/Screens/BehaviorPractice/Restaurant/Activity3/act3.dart';
import 'package:lottie/lottie.dart';
import 'package:audioplayers/audioplayers.dart';

class RestaurantGoodBadActivity2 extends StatefulWidget {
  const RestaurantGoodBadActivity2({super.key});

  @override
  State<RestaurantGoodBadActivity2> createState() =>
      _RestaurantGoodBadActivity2State();
}

class _RestaurantGoodBadActivity2State
    extends State<RestaurantGoodBadActivity2> {
  Timer? _timer;
  int _spentTime = 0;
  ...
  void _navigateToNext() {
    if (mounted) {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(
          builder: (context) => const RestaurantGoodBadActivity3(),
        ),
      );
    }
  }
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        const Expanded(
                          child: Text(
                            "කෑම කද්දි ඔයාට මොනවහරි අවශය වුනාම ඕඩර් කරන්නෙ කොහොමද?",
