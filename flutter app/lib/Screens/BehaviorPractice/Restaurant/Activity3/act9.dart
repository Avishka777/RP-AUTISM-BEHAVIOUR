...
import 'package:ukussa_app/Screens/BehaviorPractice/Restaurant/Activity3/act10.dart';
import 'package:lottie/lottie.dart';
import 'package:audioplayers/audioplayers.dart';

class RestaurantGoodBadActivity9 extends StatefulWidget {
  const RestaurantGoodBadActivity9({super.key});

  @override
  State<RestaurantGoodBadActivity9> createState() =>
      _RestaurantGoodBadActivity9State();
}

class _RestaurantGoodBadActivity9State
    extends State<RestaurantGoodBadActivity9> {
  Timer? _timer;
  int _spentTime = 0;
  ...
  void _navigateToNext() {
    if (mounted) {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(
          builder: (context) => const RestaurantGoodBadActivity10(),
        ),
      );
    }
  }
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        const Expanded(
                          child: Text(
                            "යාලුවෙක් ඔයාගෙන් කෑම මොනවහරි ඉල්ලනවා,, ඔයා මොකද කරන්නේ?",
