...
import 'package:ukussa_app/Screens/BehaviorPractice/Restaurant/Activity3/celebrationPage.dart';
import 'package:lottie/lottie.dart';
import 'package:audioplayers/audioplayers.dart';

class RestaurantGoodBadActivity10 extends StatefulWidget {
  const RestaurantGoodBadActivity10({super.key});

  @override
  State<RestaurantGoodBadActivity10> createState() =>
      _RestaurantGoodBadActivity10State();
}

class _RestaurantGoodBadActivity10State
    extends State<RestaurantGoodBadActivity10> {
  Timer? _timer;
  int _spentTime = 0;
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        const Expanded(
                          child: Text(
                            "ඔයාගේ බඩ පිරිලා ඔයාගේ කෑම ඉතුරුවෙලා තියනවිට ඔයා මොකද කරන්නේ?",
