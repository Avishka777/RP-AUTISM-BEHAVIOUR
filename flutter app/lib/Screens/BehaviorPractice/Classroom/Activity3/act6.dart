...
import 'package:ukussa_app/Screens/BehaviorPractice/Classroom/Activity3/act7.dart';
import 'package:lottie/lottie.dart';
import 'package:audioplayers/audioplayers.dart';

class ClassroomGoodBadActivity6 extends StatefulWidget {
  const ClassroomGoodBadActivity6({super.key});

  @override
  State<ClassroomGoodBadActivity6> createState() =>
      _ClassroomGoodBadActivity6State();
}

class _ClassroomGoodBadActivity6State
    extends State<ClassroomGoodBadActivity6> {
  Timer? _timer;
  int _spentTime = 0;
  ...
  final String _correctAnswer = '3act6-2.png';
  final String _incorrectAnswer = '3act6-1.png';

  final String _questionAudio = '3act6.mp3';
  ...
  void _navigateToNext() {
    if (mounted) {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(
          builder: (context) => const ClassroomGoodBadActivity7(),
        ),
      );
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text("ක්‍රියාකාරකම 3.6"),
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        const Expanded(
                          child: Text(
                            "කලුලෑල්ල පාවිච්චි කරන්නේ කොහොමද?",
