...
import 'package:ukussa_app/Screens/BehaviorPractice/Classroom/Activity3/act3.dart';
import 'package:lottie/lottie.dart';
import 'package:audioplayers/audioplayers.dart';

class ClassroomGoodBadActivity2 extends StatefulWidget {
  const ClassroomGoodBadActivity2({super.key});

  @override
  State<ClassroomGoodBadActivity2> createState() =>
      _ClassroomGoodBadActivity2State();
}

class _ClassroomGoodBadActivity2State
    extends State<ClassroomGoodBadActivity2> {
  Timer? _timer;
  int _spentTime = 0;
  ...
  final String _correctAnswer = '3act2-2.png';
  final String _incorrectAnswer = '3act2-1.png';

  final String _questionAudio = '3act2.mp3';
  ...
  void _navigateToNext() {
    if (mounted) {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(
          builder: (context) => const ClassroomGoodBadActivity3(),
        ),
      );
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text("ක්‍රියාකාරකම 3.2"),
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        const Expanded(
                          child: Text(
                            "යාලුවෙක් ඔයාගෙන් පැන්සලක් ඉල්ලනවා, ඔයා මොකද කරන්නේ?",
