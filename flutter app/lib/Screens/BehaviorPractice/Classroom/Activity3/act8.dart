...
import 'package:ukussa_app/Screens/BehaviorPractice/Classroom/Activity3/act9.dart';
import 'package:lottie/lottie.dart';
import 'package:audioplayers/audioplayers.dart';

class ClassroomGoodBadActivity8 extends StatefulWidget {
  const ClassroomGoodBadActivity8({super.key});

  @override
  State<ClassroomGoodBadActivity8> createState() =>
      _ClassroomGoodBadActivity8State();
}

class _ClassroomGoodBadActivity8State
    extends State<ClassroomGoodBadActivity8> {
  Timer? _timer;
  int _spentTime = 0;
  ...
  final String _correctAnswer = '3act8-1.png';
  final String _incorrectAnswer = '3act8-2.png';

  final String _questionAudio = '3act8.mp3';
  ...
  void _navigateToNext() {
    if (mounted) {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(
          builder: (context) => const ClassroomGoodBadActivity9(),
        ),
      );
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text("ක්‍රියාකාරකම 3.8"),
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        const Expanded(
                          child: Text(
                            "පන්තියේ මල්පෝච්චිය ලස්සන කරන්නේ කොහොමද?",
