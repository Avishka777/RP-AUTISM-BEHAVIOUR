...
import 'package:ukussa_app/Screens/BehaviorPractice/Classroom/Activity3/act4.dart';
import 'package:lottie/lottie.dart';
import 'package:audioplayers/audioplayers.dart';

class ClassroomGoodBadActivity3 extends StatefulWidget {
  const ClassroomGoodBadActivity3({super.key});

  @override
  State<ClassroomGoodBadActivity3> createState() =>
      _ClassroomGoodBadActivity3State();
}

class _ClassroomGoodBadActivity3State
    extends State<ClassroomGoodBadActivity3> {
  Timer? _timer;
  int _spentTime = 0;
  ...
  final String _correctAnswer = '3act3-2.png';
  final String _incorrectAnswer = '3act3-1.png';

  final String _questionAudio = '3act3.mp3';
  ...
  void _navigateToNext() {
    if (mounted) {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(
          builder: (context) => const ClassroomGoodBadActivity4(),
        ),
      );
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text("ක්‍රියාකාරකම 3.3"),
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        const Expanded(
                          child: Text(
                            "පොත් පෙන්නන්න ටීචර් ලගට යාලුවො එක්ක යන්නෙ කොහොමද?",
