...
import 'package:ukussa_app/Screens/BehaviorPractice/Classroom/Activity3/parentRatingPage.dart';
import 'package:ukussa_app/Screens/BehaviorPractice/Classroom/Activity3/act6.dart';
import 'package:audioplayers/audioplayers.dart';


class ClassroomGoodBadActivity5 extends StatefulWidget {
  const ClassroomGoodBadActivity5({super.key});

  @override
  State<ClassroomGoodBadActivity5> createState() =>
      _ClassroomGoodBadActivity5State();
}

class _ClassroomGoodBadActivity5State
    extends State<ClassroomGoodBadActivity5> {
  Timer? _timer;
  int _spentTime = 0;
  ...
  void _navigateToNext() {
    ...
    if (_isAnswered) {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(
          builder: (context) => const ClassroomGoodBadActivity6(),
        ),
      );
    }
  }
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        const Expanded(
                          child: Text(
                            "පන්තියේ ඔයාගේ මේසේ පිලිවලට තියාගන්නේ කොහොමද?",
