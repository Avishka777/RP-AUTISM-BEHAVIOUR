...
import 'package:ukussa_app/Screens/BehaviorPractice/Classroom/Activity3/celebrationPage.dart';
import 'package:lottie/lottie.dart';
import 'package:audioplayers/audioplayers.dart';

class ClassroomGoodBadActivity10 extends StatefulWidget {
  const ClassroomGoodBadActivity10({super.key});

  @override
  State<ClassroomGoodBadActivity10> createState() =>
      _ClassroomGoodBadActivity10State();
}

class _ClassroomGoodBadActivity10State
    extends State<ClassroomGoodBadActivity10> {
  Timer? _timer;
  int _spentTime = 0;
  ...
  final String _correctAnswer = '3act10-1.png';
  final String _incorrectAnswer = '3act10-2.png';

  final String _questionAudio = '3act10.mp3';
  ...
  void _navigateToNext() {
    if (mounted) {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(
          builder: (context) => const CelebrationPage(),
        ),
      );
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text("ක්‍රියාකාරකම 3.10"),
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        const Expanded(
                          child: Text(
                            "ඔයාට මකනයක් ඕන වෙනවා, ඔයා මොකද කරන්නේ?",
