...
import 'package:ukussa_app/Screens/BehaviorPractice/Classroom/Activity3/act2.dart';
import 'package:lottie/lottie.dart';
import 'package:audioplayers/audioplayers.dart';

class ClassroomGoodBadActivity1 extends StatefulWidget {
  const ClassroomGoodBadActivity1({super.key});

  @override
  State<ClassroomGoodBadActivity1> createState() =>
      _ClassroomGoodBadActivity1State();
}

class _ClassroomGoodBadActivity1State
    extends State<ClassroomGoodBadActivity1> {
  Timer? _timer;
  int _spentTime = 0;
  ...
  final String _correctAnswer = '3act1-1.png';
  final String _incorrectAnswer = '3act1-2.png';

  final String _questionAudio = '3act1.mp3';
  ...
  void _playQuestionAudio() async {
    ...
    await _audioPlayer.play(AssetSource('audio/cr-aquiz/$_questionAudio'));
  }

  /// Shows an animated feedback dialog after an answer is selected.
  ...
  void _handleSelection(String selection) async {
    if (_isAnswered) return; // Prevents changing the answer after selection.

    // Stop any playing audio before playing feedback sound.
    await _audioPlayer.stop();
  ...
  void _navigateToNext() {
    if (mounted) {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(
          builder: (context) => const ClassroomGoodBadActivity2(),
        ),
      );
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text("ක්‍රියාකාරකම 3.1"),
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        const Expanded(
                          child: Text(
                            "ටීචර් ඔයාගෙන් ප්‍රශ්නයක් ඇසූවිට පිලිතුරු ලබාදෙන්නේ කෙසේද?",
        ...
        child: Stack(
          ...
          children: [
            ClipRRect(
              ...
              child: Image.asset(
                'assets/images/cr-quiz/$imageName',
                width: size,
                height: size,
                fit: BoxFit.cover,
