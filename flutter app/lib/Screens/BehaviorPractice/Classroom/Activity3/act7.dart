...
import 'package:ukussa_app/Screens/BehaviorPractice/Classroom/Activity3/act8.dart';
import 'package:lottie/lottie.dart';
import 'package:audioplayers/audioplayers.dart';

class ClassroomGoodBadActivity7 extends StatefulWidget {
  const ClassroomGoodBadActivity7({super.key});

  @override
  State<ClassroomGoodBadActivity7> createState() =>
      _ClassroomGoodBadActivity7State();
}

class _ClassroomGoodBadActivity7State
    extends State<ClassroomGoodBadActivity7> {
  Timer? _timer;
  int _spentTime = 0;
  ...
  final String _correctAnswer = '3act7-2.png';
  final String _incorrectAnswer = '3act7-1.png';

  final String _questionAudio = '3act7.mp3';
  ...
  void _navigateToNext() {
    if (mounted) {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(
          builder: (context) => const ClassroomGoodBadActivity8(),
        ),
      );
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text("ක්‍රියාකාරකම 3.7"),
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        const Expanded(
                          child: Text(
                            "මේසේ තියන පොතක් බිමට වැටුනම ඔයා මොකද කරන්නේ?",
