...
import 'package:ukussa_app/Screens/BehaviorPractice/Classroom/Activity3/act5.dart';
import 'package:lottie/lottie.dart';
import 'package:audioplayers/audioplayers.dart';

class ClassroomGoodBadActivity4 extends StatefulWidget {
  const ClassroomGoodBadActivity4({super.key});

  @override
  State<ClassroomGoodBadActivity4> createState() =>
      _ClassroomGoodBadActivity4State();
}

class _ClassroomGoodBadActivity4State
    extends State<ClassroomGoodBadActivity4> {
  Timer? _timer;
  int _spentTime = 0;
  ...
  void _navigateToNext() {
    if (mounted) {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(
          builder: (context) => const ClassroomGoodBadActivity5(),
        ),
      );
    }
  }
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        const Expanded(
                          child: Text(
                            "පන්තිය ඉවර උනාම නිවැරිදිව ඔයාගෙ පුටුව තියන්නේ කොහොමද?",
