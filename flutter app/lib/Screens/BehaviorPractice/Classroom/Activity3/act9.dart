...
import 'package:ukussa_app/Screens/BehaviorPractice/Classroom/Activity3/act10.dart';
import 'package:lottie/lottie.dart';
import 'package:audioplayers/audioplayers.dart';

class ClassroomGoodBadActivity9 extends StatefulWidget {
  const ClassroomGoodBadActivity9({super.key});

  @override
  State<ClassroomGoodBadActivity9> createState() =>
      _ClassroomGoodBadActivity9State();
}

class _ClassroomGoodBadActivity9State
    extends State<ClassroomGoodBadActivity9> {
  Timer? _timer;
  int _spentTime = 0;
  ...
  final String _correctAnswer = '3act9-2.png';
  final String _incorrectAnswer = '3act9-1.png';

  final String _questionAudio = '3act9.mp3';
  ...
  void _navigateToNext() {
    if (mounted) {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(
          builder: (context) => const ClassroomGoodBadActivity10(),
        ),
      );
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text("ක්‍රියාකාරකම 3.9"),
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        const Expanded(
                          child: Text(
                            "ඔයාට පාඩම තේරෙන්නේ නැති වුනාම මොකද්ද කරන්නේ?",
