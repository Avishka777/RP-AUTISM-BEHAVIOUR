...
import 'package:ukussa_app/Screens/BehaviorPractice/Classroom/Activity1/parentRatingPage.dart';
import 'package:ukussa_app/Utils/activityPreferences.dart';
import 'package:audioplayers/audioplayers.dart';

class ClassroomIdentificationActivity extends StatefulWidget {
  const ClassroomIdentificationActivity({super.key});

  @override
  State<ClassroomIdentificationActivity> createState() =>
      _ClassroomIdentificationActivityState();
}

class _ClassroomIdentificationActivityState
    extends State<ClassroomIdentificationActivity> {
  Timer? _timer;
  int _spentTime = 0;
  ...
  void _handleSelection(String selection) {
    ...
    final isCorrect = selection == 'act1-2.png';
    final marks = isCorrect ? 100 : 0;

    // Set completion status
    ActivityPreferences.setClassroomIdentificationCompleted(true);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text("පන්තිකාමරය හඳුනාගැනීම"),
  ...
  Widget _buildImageOption(String imageName, double size) {
    ...
    final isCorrect = imageName == 'act1-2.png';
        ...
        child: Column(
          children: [
            ClipRRect(
              ...
              child: Image.asset(
                'assets/images/cr-quiz/$imageName', // Make sure you have these images in your assets folder
                width: size,
                height: size,
                fit: BoxFit.cover,
              ),
