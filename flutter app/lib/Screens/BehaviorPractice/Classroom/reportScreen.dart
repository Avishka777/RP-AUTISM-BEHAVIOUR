...
class _ReportScreenState extends State<ReportScreen> {
  ...
  final Map<String, String> _activityNameMapping = {
    'activity1': 'ඉගෙනගන්න තැන තෝරන්න',
    'activity2': 'පන්තියේ දේවල් රවුම තුලට දාමු',
    'activity3_1': 'ටීචර්ගේ ප්‍රශ්නයට පිලිතුරු දෙන්නේ කොහොමද?',
    'activity3_2': 'යාලුවා පැන්සලක් ඉල්ලනවා',
    'activity3_3': 'ටීචර් ලගට යාලුවො එක්ක යන්නේ කොහොමද?',
    'activity3_4': 'පන්තිය ඉවර උනාම පුටුව තියන්නේ කොහොමද?',
    'activity3_5': 'මේසය පිලිවලට තියාගන්නේ කොහොමද?',
    'activity3_6': 'කලුලෑල්ල පාවිච්චි කරන්නේ කොහොමද?',
    'activity3_7': 'පොත බිමට වැටුනම මොකද කරන්නේ',
    'activity3_8': 'මල්පෝච්චිය ලස්සන කරන්නේ කොහොමද?',
    'activity3_9': 'පාඩම තේරෙන්නේ නැතිනම් මොකද කරන්නේ',
    'activity3_10': 'මකනයක් ඕන වෙනවා',
  };
