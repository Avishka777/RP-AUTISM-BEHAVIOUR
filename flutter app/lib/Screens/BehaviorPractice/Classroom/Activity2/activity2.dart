...
import 'package:ukussa_app/Screens/BehaviorPractice/Classroom/Activity2/parentRatingPage.dart';
import 'package:audioplayers/audioplayers.dart';

class ClassroomEquipmentActivity extends StatefulWidget {
  const ClassroomEquipmentActivity({super.key});

  @override
  State<ClassroomEquipmentActivity> createState() =>
      _ClassroomEquipmentActivityState();
}
...
class _ClassroomEquipmentActivityState
    extends State<ClassroomEquipmentActivity> {
  ...
  final List<String> correctImages = [
    "cr-drag2", "cr-drag4", "cr-drag5"
    //,"cr-drag6", "cr-drag7", "cr-drag10", "cr-drag11"
  ];
  ...
  void initState() {
    ...
    _items = List.generate(5, (index) {
      final imageName = "cr-drag${index + 1}";
                    ...
                    Expanded(
                      child: Row(
                        children: [
                          const Expanded(
                            child: Text(
                              "පන්තියේ තියෙන දේවල් රවුම තුලට දාමු:",
                              style: TextStyle(
                                  fontSize: 18,
